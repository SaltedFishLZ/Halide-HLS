#ifndef UNIFIEDBUFFER_H
#define UNIFIEDBUFFER_H
#include "Stencil.h"
...
class U_BUFFER {
    public:
        static void call(
            stream<PackedStencil<T, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> > & in_stream,
            stream<PackedStencil<T, OUT_EXTENT_0, OUT_EXTENT_1, OUT_EXTENT_2, EXTENT_3> > & out_stream,
            // currently only support concurrently reading / writing 1 bank
            ...
            static_assert(IN_EXTENT_2 == OUT_EXTENT_2);
            static_assert(IN_EXTENT_3 == OUT_EXTENT_3);

            // A special optimization with saving of one more bank, output_stencil = output_chunk
            PackedStencil<T, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> buffer[BANK_NUM][BANK_EXTENT];
...
#pragma HLS DEPENDENCE variable=buffer intra false
                ...
                if (i < initial_cnt) {
                    ...
                    PackedStencil<T, IN_EXTENT_0, IN_EXTENT_1, IN_EXTENT_2, EXTENT_3> data = in_stream.read();
                ...
                // steady state
                    ...
                    if ( in_cnt < out_stencil_cnt) {
                       ...
                       uint32_t out_addr = out_addr_stream.read();
                        ...
                        for (size_t idx_line = 0; idx_line < 1; idx_line++) {
