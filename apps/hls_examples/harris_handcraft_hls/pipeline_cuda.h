...
int pipeline_cuda(struct halide_buffer_t *_p3___input_buffer, struct halide_buffer_t *_output__2_buffer) HALIDE_FUNCTION_ATTRS;
...
int pipeline_cuda_old_buffer_t(struct buffer_t *_p3___input, struct buffer_t *_output__2) HALIDE_FUNCTION_ATTRS;
