...
int pipeline_hls(struct halide_buffer_t *_p2___input_buffer, struct halide_buffer_t *_output__1_buffer) HALIDE_FUNCTION_ATTRS;
...
int pipeline_hls(struct buffer_t *_p2___input, struct buffer_t *_output__1) HALIDE_FUNCTION_ATTRS;
