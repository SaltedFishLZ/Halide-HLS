...
int pipeline_native(struct halide_buffer_t *_p1___input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
...
int pipeline_native_old_buffer_t(struct buffer_t *_p1___input, struct buffer_t *_output) HALIDE_FUNCTION_ATTRS;
